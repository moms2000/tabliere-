      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        {[
          ...
          },
          {
            ...
            content: `Les présentes mentions légales sont soumises au droit de la République de Côte d'Ivoire. En cas de litige relatif à l'utilisation du site tabliereci.net, les tribunaux d'Abidjan seront seuls compétents.\n\nPour toute question relative aux présentes mentions légales :\nE-mail : legal@tabliereci.net\nAdresse : TablièreCI, Abidjan Plateau, Côte d'Ivoire`
          },
        ].map((s, i) => (
