...
router.get   ("/analytics",         ctrl.paymentsAnalytics); // avant /:id — stats par moyen de paiement
router.get   ("/history",           ctrl.paymentsHistory);   // avant /:id — historique des encaissements
